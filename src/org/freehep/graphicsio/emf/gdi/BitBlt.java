 ...
 * @version $Id: freehep-graphicsio-emf/src/main/java/org/freehep/graphicsio/emf/gdi/BitBlt.java c0f15e7696d3 2007/01/22 19:26:48 duns $
 */
public class BitBlt extends EMFTag implements EMFConstants {
    ...
    public EMFTag read(int tagID, EMFInputStream emf, int len)
        ...
        BlendFunction fakebf = new BlendFunction(AC_SRC_OVER, 0, 0xFF, AC_SRC_ALPHA);
    ...
    public void render(EMFRenderer renderer) {
        ...
        else if(dwROP == EMFConstants.PATCOPY)
