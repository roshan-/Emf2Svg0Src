 ...
 */
public class LogFontPanose implements EMFConstants, GDIObject {
    ...
    public LogFontPanose(LogFontW font, String fullName, String style,
    ...
    public LogFontPanose(Font font) {
    ...
    public LogFontPanose(EMFInputStream emf) throws IOException {
