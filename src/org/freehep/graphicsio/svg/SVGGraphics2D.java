...
public class SVGGraphics2D extends AbstractVectorGraphicsIO {
    ...
    static {
        ...
        defaultProperties.setProperty(EXPORT_IMAGES, false); //FIXME ASF antes false
        ...
        defaultProperties.setProperty(EMBED_FONTS, true); //FIXME ASF antes false
    ...
    public void writeHeader() throws IOException {
        ...
        if (getProperty(VERSION).equals(VERSION_1_1)) {
            ...
            os.println("     xmlns:dc=\"http://purl.org/dc/elements/1.1/\"");
            os.println("     xmlns:cc=\"http://creativecommons.org/ns#\"");
            os.println("     xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"");
            os.println("     xmlns:svg=\"http://www.w3.org/2000/svg\"");
    ...
    protected void writeImage(RenderedImage image, AffineTransform xform,
        ...
        if (isProperty(EXPORT_IMAGES)) {
            ...
            Base64EncoderStream b64 = new Base64EncoderStream (new WriterOutputStream(writer)); 
...
/*            Base64OutputStream b64 = new Base64OutputStream(
    ...
    private String getClippedString(String s) {
        ...
        if (isProperty(CLIP) && getClip() != null) {
            ...
            result.append("id=\"clip" + clipNumber.getInt() + "\">\n  ");
            result.append("clipPathUnits=\"userSpaceOnUse\"\n");                        		            
