...
//        }
    ...
    public SVGFontDescriptor toSVG(Font font, FontRenderContext frc) {
        ...
        //DIA9 String fontSize = "" + doubleString(font.getSize2D());
//        String fontSize = "" + doubleString(font.getSize2D()/ 7.5);
    ...
    public static String familyToSVG(Font font) {
        // DIA9 String fontFamilyStr = font.getFamily();
        String fontFamilyStr = font.getName();
