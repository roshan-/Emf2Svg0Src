...
public class DefaultStyleHandler implements StyleHandler, SVGConstants {
	...
	/**
	 * Static initializer for which attributes should be ignored on some
	 * elements. Map-key is a string like 'SVG_RECT_TAG' , map-entry is a set of
	 * strings, which denote font-attributes to ignore. The set is shared by all
	 * map-entries.
	 */
	 ...
	 * 
	 * @param element
	 *            the SVG <code>Element</code> to be styled.
	 * @param styleMap
	 *            the <code>Map</code> containing pairs of style property names,
	 *            style values.
	 */
	public void setStyle(Element element, Map styleMap,
		...
		while (iter.hasNext()) {
			...
			if (!styleName.equals("clip-path") || !tagName.equals("text")) {
