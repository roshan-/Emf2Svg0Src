...
public class SVGGeneratorContext implements ErrorConstants {
     ...
     * interfaces.
     */
    public GenericImageHandler genericImageHandler;
     ...
     * @see #setErrorHandler
     */
    public SVGGeneratorContext(Document domFactory) {
